...
export const TEXT_COLOR_THEMES: Record<TextColorTheme, ColorThemeDefinition> = {
  ...
  rosegold: {
    ...
    clearcoat: 0.95,
    glowColor: "#fda4af",
    dotGradient: "from-rose-500 to-pink-300",
    ringColor: 0xfda4af,
  ...
  amethyst: {
    ...
    clearcoat: 0.95,
    glowColor: "#c084fc",
    dotGradient: "from-purple-600 to-fuchsia-300",
    ringColor: 0xc084fc,
  ...
  obsidian: {
    id: "obsidian",
    name: "Obsidian Noir",
    nameBengali: "অ্যাবসিডিয়ান ব্ল্যাক",
    frontColor: 0x27272a,
    sideColor: 0x09090b,
    metalness: 0.9,
    roughness: 0.18,
    clearcoat: 0.8,
    glowColor: "#52525b",
    dotGradient: "from-zinc-900 to-zinc-600",
    ringColor: 0x3f3f46,
    particleColor: 0x71717a,
  },
};
